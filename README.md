...
- Комната в стиле мягкого интерфейса с крупным окном, белёсым стеклом, карточками тем и переключением сцен
- Вкладки вместо одновременного вывода всех блоков: `Комната`, `Практики`, `Дневник`, `Интерактив`
- На мобильных — фиксированная нижняя навигация, на desktop — боковое меню
