...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(185,212,226,0.9),rgba(240,245,248,0.96)_30%,rgba(233,240,244,1)_100%)] px-3 py-4 text-slate-700 sm:px-4">
      <div className="mx-auto flex w-full max-w-3xl flex-col gap-4">
        <aside className="overflow-hidden rounded-[36px] border border-white/60 bg-[linear-gradient(180deg,rgba(255,255,255,0.66),rgba(229,238,243,0.72)),url('/backgrounds/forest.jpg')] bg-cover bg-center shadow-soft">
          <div className="flex h-full flex-col bg-[linear-gradient(180deg,rgba(255,255,255,0.74),rgba(214,229,236,0.54))] p-5 backdrop-blur-md">
            ...
            <div className="mt-5 rounded-[28px] bg-white/35 p-4">
        ...
        <section className="rounded-[36px] border border-white/60 bg-white/72 p-4 shadow-soft backdrop-blur-md sm:p-6">
